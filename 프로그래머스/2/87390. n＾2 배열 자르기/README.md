...
### 문제풀이 과정
- ver1 : n*n 배열 생성 후 숫자를 채우고 필요한 부분 슬라이싱 -> 메모리 초과 발생
- ver2 : y축은 몫, x축은 나머지로 구하는 법까지는 유추했으나, 예외케이스를 잡지못해서 풀이 실패
- 최종풀이 : 다른 사람 풀이를 참고하여 불필요한 변수 제거

[문제 링크](https://school.programmers.co.kr/learn/courses/30/lessons/87390) 

### 성능 요약

메모리: 102 MB, 시간: 4.62 ms
